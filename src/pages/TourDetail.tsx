...
export default function TourDetail() {
  ...
  if (!trick) return <p className="text-sm text-ink/50">Tour introuvable.</p>
  ...
  return (
    <div className="space-y-6">
      <Link to="/tours" className="inline-flex items-center gap-1 text-sm text-ink/50">
      ...
      <div>
        ...
        {steps.length === 0 && (
          <p className="text-sm text-ink/50 mb-2">
            Pas encore d'étapes — ajoute une progression personnalisée pour ce tour.
          </p>
        )}
